...
namespace DiscordTrain.JMRIConnector.Services
{
    public class JMRIMessageSerializer : IMessageSerializer
    {
        ...
        /*
        [{"type":"sensor","data":{"name":"MSIR01","userName":"RPi IR sensor","comment":null,"properties":[],"inverted":false,"state":4}},{"type":"sensor","data":{"name":"MSIR02","userName":"RPi IR sensor1","comment":null,"properties":[],"inverted":true,"state":2}},{"type":"sensor","data":{"name":"MSIR03","userName":"RPi IR sensor2","comment":null,"properties":[],"inverted":false,"state":0}},{"type":"sensor","data":{"name":"MSIR04","userName":"RPi IR sensor3","comment":null,"properties":[],"inverted":false,"state":0}},{"type":"sensor","data":{"name":"MSIR05","userName":"RPi IR sensor4","comment":null,"properties":[],"inverted":false,"state":2}}]
